...
function sex()
    ...
    local win = DiscordLib:Window("[🌊UPD 1] Anime Adventures - BonzoScripts".." - "..tostring(identifyexecutor()))
    ...
    credits:Label("1hz#8290")
    credits:Button("Join Bonzo", function()
        setclipboard("https://discord.gg/trQpurRwYw")
